...
public class JPAQueryExample {
	...
	void retriveCompanyByCompanyName(String companyName) {
		...
		try {
			...
			Query query1 = entityManager.createQuery("SELECT c FROM Company c WHERE c.companyName like :cn ");
			query1.setParameter("cn", companyName + "%");
	...
	public static void main(String[] args) {
		...
		jpaQueryExample.retriveCompanyByCompanyName("App");
