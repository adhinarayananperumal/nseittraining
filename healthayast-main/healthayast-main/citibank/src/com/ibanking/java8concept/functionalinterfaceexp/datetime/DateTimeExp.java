...
public class DateTimeExp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Japan time............... " + t);

		// Create a zoned date time object with current date and time and New York time
		// zone ID:
		LocalDateTime today1 = LocalDateTime.now(ZoneId.of("America/Chicago"));
		...
		// uk
		// Europe/London
		LocalDateTime todayuk = LocalDateTime.now(ZoneId.of("Europe/London"));
		ZoneId timeZone1todayuk = ZoneId.of("Europe/London");
		ZonedDateTime todayWithTimeZone1todayuk = ZonedDateTime.of(todayuk, timeZone1todayuk);
		System.out.format("Formatted date tFime with zone ID of todayuk is %s\n",
				todayWithTimeZone1todayuk.format(formatTodayWithZoneId));
